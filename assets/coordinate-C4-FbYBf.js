...
`,e.jsxs(r.p,{children:[e.jsx("code",{children:"Array|null"})," The parsed pair of coordinate values (LV95) or null."]})]})}function l(n={}){const{wrapper:r}={...d(),...n.components};return r?e.jsx(r,{...n,children:e.jsx(s,{...n})}):s(n)}export{l as default};
