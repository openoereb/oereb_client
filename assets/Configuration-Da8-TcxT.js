import{j as e}from"./iframe-BRWzqT9J.js";import{useMDXComponents as o}from"./index-a2XW11_U.js";import{M as i}from"./blocks-DjkJG0Lw.js";import"./preload-helper-D9Z9MdNV.js";import"./index-BL8cfqU8.js";function a(t){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"User Guide/Configuration"}),`
...
`,e.jsx(n.a,{href:"https://github.com/mkaranasou/pyaml_env",rel:"nofollow",children:"pyaml-env"}),`. This allows you to use
...
`})}),`
`,e.jsx(n.h3,{id:"messages-file",children:"Messages file"}),`
`,e.jsx(n.p,{children:`You can optionally add a file with messages to be shown on application start. This
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-yaml",children:`  # [OPTIONAL] Specify a number of notices that are shown on application start.
...
`,e.jsx(n.a,{href:"https://github.com/openoereb/oereb_client/blob/main/samples/search.py",rel:"nofollow",children:"samples package"}),` for some
...
`})})]})}function h(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a(t)}export{h as default};
