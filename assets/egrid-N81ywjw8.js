...
`,e.jsxs(r.p,{children:[e.jsx("code",{children:"Promise"})," A promise receiving the query results."]})]})}function a(n={}){const{wrapper:r}={...s(),...n.components};return r?e.jsx(r,{...n,children:e.jsx(t,{...n})}):t(n)}export{a as default};
