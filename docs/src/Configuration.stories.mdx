...
oereb_client:
  ...
  # Optional parameter to display a short notice in the user interface.
  ...
  # Optional parameter to enable tiled WMS requests (default is False)
  use_tile_wms: True
...
[samples package](https://github.com/openoereb/oereb_client/blob/master/samples/search.py) for some
