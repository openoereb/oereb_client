...
oereb_client:
  ...
  # white layer) on the surrounding cantons. You have to define a WMS URL.
  # This parameter does not have to be configured. If it is configured, url has to be defined.
  mask_surrounding:
    url: https://example.com/wms
```
